...
var CartClass = /** @class */ (function () {
    ...
    CartClass.prototype.showCurrent = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, cart, i, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT id, name, price, url, description, amount FROM products INNER JOIN orders ON product_id = id';
