    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                token = jsonwebtoken_1.default.sign(users, process.env.TOKEN_SECRET);
                res.json({
                    id: users.id,
                    jwt: token,
                });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user.validate(req.body.id, req.body.password)];
            case 1:
                users = _a.sent();
                if (users.id === 0) {
...
var user_routes = function (app) {
    app.get('/user', product_1.auth, index);
    app.get('/user/:id', product_1.auth, show);
